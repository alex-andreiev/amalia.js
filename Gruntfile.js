            ...
            build: {
                files: {
                    ...
                    'build/js/<%= pkg.name %>.min.js': [
                        ...
                        'src/player/widgets/captions-button.js',
                        'src/player/widgets/download-button.js',
                        'src/player/widgets/playlist-button.js',
                        'src/player/widgets/playlist-menu-button.js',
